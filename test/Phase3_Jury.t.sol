...
contract Phase3_JuryTest is BaseTest {
    ...
    function test_P3_3_MajorityResolves() public {
        ...
        assertEq(uint256(status), uint256(BuilderEngine.Status.Completed), "Should be completed (True)");
    }
    ...
    function test_P3_4_WrongJurorsLoseStake() public {
        ...
        // Make Majority TRUE
        address hr2 = address(0x44);
        vm.deal(hr2, 10e18);
        giveReputation(hr2, 20e18);
        address hr3 = address(0x55);
        vm.deal(hr3, 10e18);
        giveReputation(hr3, 20e18);
